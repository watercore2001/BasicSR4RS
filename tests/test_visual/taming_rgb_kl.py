...
from basicsr.archs.autoencoder_arch import AutoencoderKLTorch
import torch
...
params = torch.load("experiments/pretrained_models/ldm_kl_f4.pth", map_location=device)

model.load_state_dict(params)
model.eval()

visual_fodler = "ldm_kl"
