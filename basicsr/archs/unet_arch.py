...
from .resshift.fp16_util import convert_module_to_f16, convert_module_to_f32
from .resshift.basic_ops import (
    linear,
    conv_nd,
    avg_pool_nd,
    zero_module,
...
from .resshift.swin_transformer import BasicLayer
...
class UNetModelSwin(nn.Module):
    ...
    def __init__(
        ...
        if cond_lq and lq_size == image_size:
            ...
            base_chn = 4 if cond_mask else in_channels
        else:
            feature_extractor = []
            feature_chn = 4 if cond_mask else in_channels
            base_chn = 16
